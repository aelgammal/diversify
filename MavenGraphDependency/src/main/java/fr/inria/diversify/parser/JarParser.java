...
//        System.out.println("unzip -d " + tmpDir.getAbsolutePath() + " " + jar);
//        Process p = r.exec("unzip -d " +tmpDir.getAbsolutePath() + " "+jar);
...
//                calls.add(new Signature(tmp[tmp.length-1]));
...
//        System.out.println(result);
    ...
    protected String runJavap(String args, String directory, String classFileName) {
        ...
        Runtime r = Runtime.getRuntime();
        try {
//            System.out.println("javap " + args+ " -classpath "+directory+" "+classFileName);
